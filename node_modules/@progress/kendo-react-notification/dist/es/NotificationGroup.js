...
var NotificationGroup = /** @class */ (function (_super) {
    ...
    NotificationGroup.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'k-notification-group' + (className ? " " + className : ''), style: __assign({ alignItems: 'center', flexWrap: 'wrap' }, style) }, this.props.children));
    };
    /**
     * @hidden
     */
