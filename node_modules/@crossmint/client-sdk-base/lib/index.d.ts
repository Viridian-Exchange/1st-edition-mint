...
interface CrossmintModalServiceReturn {
    connect: (mintConfig: PayButtonConfig, collectionTitle?: string, collectionDescription?: string, collectionPhoto?: string, mintTo?: string, emailTo?: string, listingId?: string, whPassThroughArgs?: any) => void;
}
declare function crossmintModalService({ clientId, libVersion, showOverlay, setConnecting, environment, clientName, }: CrossmintModalServiceParams): CrossmintModalServiceReturn;

interface IProps {
    onClick?: (e: any) => void;
    connecting: boolean;
}
declare function crossmintPayButtonService({ onClick, connecting }: IProps): {
    checkProps: ({ collectionTitle, collectionDescription, collectionPhoto }: any) => any[];
    getButtonText: (connecting: boolean) => "Connecting ..." | "Buy with credit card";
...
export { BaseButtonProps, CrossmintModalServiceReturn, CrossmintPayButtonProps, OnboardingQueryParams, PayButtonConfig, baseUrls, clientNames, crossmintModalService, crossmintPayButtonService, crossmintStatusButtonService, crossmintStatusService, customHeaders, generateClientId, mintingContractTypes, onboardingRequestStatusResponse };
